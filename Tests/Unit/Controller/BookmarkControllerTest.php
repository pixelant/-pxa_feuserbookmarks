...
/**
 * Test case for class Tx_Pxa_feuserbookmarks_Controller_BookmarkController.
 *
 * @version $Id$
 ...
 */
class Tx_Pxa_feuserbookmarks_Controller_BookmarkControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
